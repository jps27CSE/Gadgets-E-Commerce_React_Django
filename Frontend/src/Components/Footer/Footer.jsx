...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 mb-3">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Gadget Store Ltd. <br />Providing reliable tech since 2022</p>
                </aside>
